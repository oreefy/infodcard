...
export default function Create({ link }: { link: string }) {
    ...
    const createProduct = (event: any) => {
        ...
        Fetch("/api/account/product/create", { method: "POST", body: input }).then((res) => {
            if (res.status === 200) {
                setErrors([]);
                reset();
                router.push("/my-account/profile/product")
            } else {
    ...
    return (
        <form onSubmit={createProduct}>
            <div>
                ...
                <input maxLength={70} className="inp-text" type="text" name="title" placeholder="Product Title" id="title" required />
            ...
            <div>
                ...
                <input maxLength={150} className="inp-text" type="text" name="message" id="message" placeholder="Product Description" />
            ...
            <div>
                ...
                <input maxLength={20} className="inp-text" type="text" name="price" id="price" placeholder="Product Price" />
