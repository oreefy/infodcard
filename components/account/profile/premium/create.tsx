...
export default function CreatePremiumProfile() {
    ...
    const createProfile = (event: any) => {
        ...
        Fetch("/api/account/profile/premium/create", { method: "POST", body: input }).then((res) => {
            if (res.status === 200) {
                setErrors([])
                reset()
            ...
            <form onSubmit={createProfile} className="grid grid-cols-1 gap-3">
                <div className="box p-0 mb-0">
                    <div className="box rounded-b-none flex gap-3 items-center justify-between m-0">
                        <h2 className="text-center font-bold text-xl ">Profile Info</h2>
                    </div>
                ...
                <div className="box p-0 mb-0">
                    <div className="box rounded-b-none flex gap-3 items-center justify-between m-0">
                        <h2 className="text-center font-bold text-xl ">Contact Info</h2>
                    </div>
                    <div className="p-3 grid grid-cols-1 gap-2">
                        <div>
                ...
                <div className="box p-0 mb-0">
                    <div className="box rounded-b-none flex gap-3 items-center justify-between m-0">
                        <h2 className="text-center font-bold text-xl ">Company Info</h2>
                    </div>
                    <div className="p-3 grid grid-cols-1 gap-2">
                        <div>
                ...
                <div className="box p-0 mb-0">
                    <div className="box rounded-b-none flex gap-3 items-center justify-between m-0">
                        <h2 className="text-center font-bold text-xl ">Social Media</h2>
                    </div>
                    <div className="p-3 grid grid-cols-1 gap-2">
                        <div>
