import Create from "@/components/account/profile/premium/create";
import Update from "@/components/account/profile/premium/update";
...
export default function CreatePremiumProfile() {
    ...
    useEffect(() => {
        Fetch("/api/account/profile/premium/views", { method: "POST" }).then((res) => {
            if (res.status === 200) {
